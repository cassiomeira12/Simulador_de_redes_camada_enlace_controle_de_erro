...
public class Computador extends VBox {
  ...
  *********************************************/
  public void adicionarMensagem(String mensagem) {
    Platform.runLater(new Runnable(){
      ...
      public void run() {
        try {
          textArea.setText(textArea.getText() + mensagem);//Limpa a Tela do Computador
          textArea.appendText("");//Descendo Scroll da tela do Computador
        } catch (Exception e) {
          System.out.println("[ERRO] ao Adicionar texto no Computador");
        }
      }
    });
  }
  ...
  *********************************************/
  public void limparTextoCamadas() {
    this.camadaAplicacao.limpar();
    this.camadaEnlace.limpar();
    this.camadaFisica.limpar();
  }
